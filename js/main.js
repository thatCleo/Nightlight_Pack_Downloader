...
if (!gotTheLock) {
  ...
  app.whenReady().then(() => {
    ...
    ipcMain.handle(
      "packFunctions:getActivePacksInOrder",
      getActivePacksInOrder,
    );
    ...
    ipcMain.handle(
      "options:getCheckForPackUpdateOnStartup",
      getCheckForPackUpdateOnStartup,
    );
    ipcMain.handle(
      "options:setCheckForPackUpdateOnStartup",
      setCheckForPackUpdateOnStartup,
    );
    ipcMain.handle(
      "options:getCheckForAppUpdateOnStartup",
      getCheckForAppUpdateOnStartup,
    );
    ipcMain.handle(
      "options:setCheckForAppUpdateOnStartup",
      setCheckForAppUpdateOnStartup,
    );
